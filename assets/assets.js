...
export const categories = ["Dog Food", "Cat Toys", "Aquarium", "Accessories", "Vet Consults", "Grooming"];
...
export const productDummyData = [
    {
        ...
        description: "Cama ortopédica de lujo diseñada para proporcionar un soporte óptimo para las articulaciones de su perro. Fabricada con espuma viscoelástica de alta calidad y una funda lavable a máquina.",
        mrp: 120,
        price: 99,
    ...
    },
    {
        ...
        description: "Juguete láser automático y giratorio que mantendrá a su gato entretenido durante horas. Múltiples velocidades y patrones aleatorios.",
        mrp: 65,
        price: 45,
        images: [product_img2],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Fórmula nutricionalmente equilibrada para perros adultos. Rica en proteínas de alta calidad y enriquecida con vitaminas esenciales.",
        mrp: 180,
        price: 155,
        images: [product_img3],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Correa retráctil resistente para perros de hasta 25kg. Con sistema de bloqueo de un botón para mayor seguridad durante los paseos.",
        mrp: 55,
        price: 39,
        images: [product_img4],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Centro de actividades y rascador multinivel para gatos. Incluye hamacas, escondites y postes recubiertos de sisal.",
        mrp: 220,
        price: 189,
        images: [product_img5],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Kit de acuario de 40 litros con filtro integrado, iluminación LED y calentador. Ideal para principiantes.",
        mrp: 350,
        price: 299,
        images: [product_img6],
        storeId: "seller_1",
    ...
    {
        id: "prod_7",
        name: "Champú Antipulgas 500ml",
        description: "Champú de tratamiento suave y eficaz para eliminar pulgas y garrapatas. Deja el pelaje brillante y con buen aroma.",
        mrp: 45,
        price: 32,
        images: [product_img7],
        storeId: "seller_1",
    ...
    {
        id: "prod_8",
        name: "Transportador Premium",
        description: "Jaula transportadora segura y ventilada para viajes. Cumple con normativas IATA para vuelos.",
        mrp: 140,
        price: 115,
        images: [product_img8],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Golosinas que ayudan a limpiar la placa y el sarro mientras su perro mastica. Sabor a pollo.",
        mrp: 25,
        price: 18,
        images: [product_img9],
        storeId: "seller_1",
    ...
    },
    {
        ...
        description: "Arena de bentonita super aglomerante con control de olores superior. Facilita la limpieza de la bandeja.",
        mrp: 65,
        price: 52,
    ...
    {
        id: "prod_11",
        name: "Comedero Lento Antiglotones",
        description: "Tazón diseñado con obstáculos para ralentizar la alimentación de perros ansiosos y prevenir problemas digestivos.",
        mrp: 38,
        price: 28,
    ...
    {
        id: "prod_12",
        name: "Arnés de Pecho Ajustable",
        description: "Arnés ergonómico y reflectante para paseos seguros nocturnos. Múltiples tallas disponibles.",
        mrp: 75,
        price: 59,
...
export const ourSpecsData = [
    { title: "Quality Pet Products", description: "Enjoy top-tier pet food, accessories, and toys for your best friend.", icon: SendIcon, accent: '#05DF72' },
    { title: "Veterinary Orientation", description: "Need advice? Access our orientative veterinary calls quickly.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "24/7 Customer Support", description: "We're here for you and your pets at any time of the day.", icon: HeadsetIcon, accent: '#A684FF' }
]
